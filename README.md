...
- 粉丝日报支持速读版和日报版两种输出长度，日报版合并原标准版与深读版的高价值结构。
- 默认中文输出，英文提问时输出英文。
- 明确标注非官方来源、传闻和未验证信息。
...
- Supports short and daily fan-daily report modes. The daily mode merges the useful parts of the previous standard and deep modes.
...
- Two tabs provide short and daily views over the same verified static data.
