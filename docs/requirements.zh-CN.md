...
- 日报版合并原标准版与深读版：保留今日重点、话题合并、官方、媒体、可选传闻和可选往日回顾；`daily_core` 社交来源进入普通日报信息流，不单独展示 X / 社交观察栏目。
- “今日重点”只展示直接命中 Oscar Piastri / Piastri / OP81 的条目；泛 F1、泛车队或赛程内容不能仅凭来源可信度进入今日重点。
