...
- 搜索规则已强制限制为最近 3 天。
- 2026-06-12 审计中，3 天内没有稳定 Oscar Piastri 命中的来源已从活跃来源列表删除。
...
可选媒体来源已在 2026-06-12 审计后从 V0.5 活跃来源列表移除，因为最近 3 天内没有找到稳定的 Oscar Piastri 信息。只有在新的审计确认最近 3 天内存在 Oscar Piastri 信息时，才重新加入被删除的来源。
