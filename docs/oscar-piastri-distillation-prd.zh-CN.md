...
X 全历史的完成口径是：从账号创建日到当前日期逐年检索，每个时间窗无错误且低于单窗上限；达到上限的时间窗继续拆月；最终按 post ID 去重，并分别统计原创、回复、转发和不可见/删除缺口。当前实际看到 553 条公开发言：2017 年 11 条、2018 年 29 条、2019 年 493 条，以及 2026-04-08 至 2026-09-02 的最新时间线 20 条；2020 至 2026-04-07 因 X 返回 HTTP 429 暂未完成。因此产品和文档仍只能标记 `partial_rate_limited`，不得称为全量。
